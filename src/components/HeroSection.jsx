...
export const HeroSection = () => {
  return (
    <section
      id="hero"
      className="flex flex-col min-h-screen relative items-center justify-center px-4 "
    >
      <div className="conatiner max-w-4xl mx-auto text-center z-10">
        <div className="space-y-6">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
            ...
            <span className="text-primary opacity-0 animate-fade-in-delay-1 ml-1">
              Yaseen
            </span>
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground max-2-2xl mx-auto opacity-0 animate-fade-in-delay-2">
            Passionate web developer crafting modern, high-performance websites.
            I transform ideas into responsive, user-friendly digital experiences
            that captivate and deliver results.
          </p>
          <div className="pt-opacity-0 animate-fade-in-delay-3">
